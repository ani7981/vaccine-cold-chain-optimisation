...
from app.api.endpoints import shipments, analytics, simulation, websocket, audit, fleet, depots, problems, routing, telemetry
...
router.include_router(routing.router, prefix="/api/routing", tags=["routing"])
router.include_router(telemetry.router, prefix="/api/telemetry", tags=["telemetry"])
